...
def parse_args():
    ...
    parser.add_argument("--vector_size", type=int, default=20, help="enter the size of the ")

    parser.add_argument("--window_size", type=int, default=2, help="enter the desired window size")

    parser.add_argument(
        "--min_count", type=int, default=1, help="enter the desired mininum count for words"
    )

    parser.add_argument("--epochs", type=int, default=25, help="enter the iteration number")

    parser.add_argument(
        "--number_of_workers", type=int, default=2, help="enter number of desired workers"
    )

    parser.add_argument(
        "--output_dir", type=str, required=True, help="enter the output directory to save the model"
    )
