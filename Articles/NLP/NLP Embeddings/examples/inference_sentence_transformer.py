...
if __name__ == "__main__":
    ...
    infer = InferenceSentenceTransformers(model_name="sentence-transformers/all-MiniLM-L6-v2")

    query_1 = input("Enter first query")

    embed_1 = infer.get_embeddings(query=query_1)

    query_2 = input("Enter second query")

    embed_2 = infer.get_embeddings(query=query_2)

    res = infer.calculate_cosine_similarity(embeds_1=embed_1, embeds_2=embed_2)
