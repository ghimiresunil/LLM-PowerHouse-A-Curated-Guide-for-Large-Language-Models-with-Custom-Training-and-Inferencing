...
def get_tokenizer(model_args: Dict, data_args: Dict) -> PreTrainedTokenizer:
...
def get_peft_config(model_args: Dict) -> PeftConfig:
...
def get_quantization_config(model_args: Dict) -> BitsAndBytesConfig:
