...
def preprocess_dataset(
    dataset, tokenizer: AutoTokenizer, max_length: int, seed=training_args["seed"]
):
...
def get_tokenizer_model(pretrained_model_name_or_path: str = DEFAULT_INPUT_MODEL):
...
def train():
    ...
    processed_dataset = preprocess_dataset(
        dataset, tokenizer=tokenizer, max_length=max_length, seed=training_args["seed"]
    )
