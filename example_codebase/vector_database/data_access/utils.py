...
class ClassificationCollection(MilvusCollectionBase):
    ...
    def create_collection(self):
        ...
        ticket_description_embeddings_field = FieldSchema(
            name="ticket_description_embeddings",
            dtype=DataType.FLOAT_VECTOR,
            dim=768
        )

        schema = CollectionSchema(
            fields=[id_field, product_purchased_field, ticket_subject_field, ticket_description_field, ticket_description_embeddings_field],
        ...
        collection.create_index(
            field_name="ticket_description_embeddings",
    ...
    def hybrid_search(self, embeddings, anns_field:str, content_name:str=None, top_k: int = 5):
        ...
        if content_name:
            ...
            search_result = self.collection.search(
                ...
                # expr = None,
                output_fields = ["id","content_name", "content"]
            )
        else:
